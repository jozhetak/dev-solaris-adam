...
* ADAM6224 device class - ADAM6217 is a 8-ch  Isolated Analog Input Modbus
TCP Module
* ADAM6224 device class - ADAM6224 is a 4-ch  Isolated Analog Output Modbus
TCP Module with additional 4-ch Digital Input
* ADAM6250 device class - ADAM6250 is a 15-ch  Isolated Digital I/O Modbus
TCP Module
